...
import type { GetStatus200Response, Register201Response, RegisterRequest } from '../models/index';
import {
...
export class DefaultApi extends runtime.BaseAPI {
	...
	async getStatusRaw(
	...
	): Promise<runtime.ApiResponse<GetStatus200Response>> {
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetStatus200ResponseFromJSON(jsonValue)
		);
	}
	...
	async registerRaw(
		...
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<Register201Response>> {
		const queryParameters: any = {};
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			Register201ResponseFromJSON(jsonValue)
		);
	}
