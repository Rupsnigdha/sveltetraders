...
export class FleetApi extends runtime.BaseAPI {
	 ...
	 * Create Chart
	 */
	async createChartRaw(
		requestParameters: CreateChartRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<CreateChart201Response>> {
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/chart`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			CreateChart201ResponseFromJSON(jsonValue)
		);
	}
	...
	async createChart(
		requestParameters: CreateChartRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<CreateChart201Response> {
	 ...
	 * Scan Ships
	 */
	async createShipShipScanRaw(
		requestParameters: CreateShipShipScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<CreateShipShipScan201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/scan/ships`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			CreateShipShipScan201ResponseFromJSON(jsonValue)
		);
	}
	...
	async createShipShipScan(
		requestParameters: CreateShipShipScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<CreateShipShipScan201Response> {
	 ...
	 * Scan Systems
	 */
	async createShipSystemScanRaw(
		requestParameters: CreateShipSystemScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<CreateShipSystemScan201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/scan/systems`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			CreateShipSystemScan201ResponseFromJSON(jsonValue)
		);
	}
	...
	async createShipSystemScan(
		requestParameters: CreateShipSystemScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<CreateShipSystemScan201Response> {
	 ...
	 * Scan Waypoints
	 */
	async createShipWaypointScanRaw(
		requestParameters: CreateShipWaypointScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<CreateShipWaypointScan201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/scan/waypoints`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			CreateShipWaypointScan201ResponseFromJSON(jsonValue)
		);
	}
	...
	async createShipWaypointScan(
		requestParameters: CreateShipWaypointScanRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<CreateShipWaypointScan201Response> {
	 ...
	 * Create Survey
	 */
	async createSurveyRaw(
		requestParameters: CreateSurveyRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<CreateSurvey201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/survey`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			CreateSurvey201ResponseFromJSON(jsonValue)
		);
	}
	...
	async createSurvey(
		requestParameters: CreateSurveyRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<CreateSurvey201Response> {
	 ...
	 */
	async dockShipRaw(
		requestParameters: DockShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<DockShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/dock`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			DockShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Extract Resources
	 */
	async extractResourcesRaw(
		requestParameters: ExtractResourcesOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ExtractResources201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/extract`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			ExtractResources201ResponseFromJSON(jsonValue)
		);
	}
	...
	async extractResources(
		requestParameters: ExtractResourcesOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<ExtractResources201Response> {
	 ...
	 */
	async extractResourcesWithSurveyRaw(
		requestParameters: ExtractResourcesWithSurveyRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ExtractResources201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/extract/survey`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
	 ...
	 */
	async getMountsRaw(
		requestParameters: GetMountsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetMounts200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/mounts`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetMounts200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 */
	async getMyShipRaw(
		requestParameters: GetMyShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetMyShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetMyShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Get Ship Cargo
	 */
	async getMyShipCargoRaw(
		requestParameters: GetMyShipCargoRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetMyShipCargo200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/cargo`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetMyShipCargo200ResponseFromJSON(jsonValue)
		);
	}
	...
	async getMyShipCargo(
		requestParameters: GetMyShipCargoRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<GetMyShipCargo200Response> {
	 ...
	 */
	async getMyShipsRaw(
		requestParameters: GetMyShipsRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetMyShips200Response>> {
		const queryParameters: any = {};
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetMyShips200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Get Repair Ship
	 */
	async getRepairShipRaw(
		requestParameters: GetRepairShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetRepairShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/repair`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetRepairShip200ResponseFromJSON(jsonValue)
		);
	}
	...
	async getRepairShip(
		requestParameters: GetRepairShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<GetRepairShip200Response> {
	 ...
	 * Get Scrap Ship
	 */
	async getScrapShipRaw(
		requestParameters: GetScrapShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetScrapShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/scrap`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetScrapShip200ResponseFromJSON(jsonValue)
		);
	}
	...
	async getScrapShip(
		requestParameters: GetScrapShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<GetScrapShip200Response> {
	 ...
	 * Get Ship Cooldown
	 */
	async getShipCooldownRaw(
		requestParameters: GetShipCooldownRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetShipCooldown200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/cooldown`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetShipCooldown200ResponseFromJSON(jsonValue)
		);
	}
	...
	async getShipCooldown(
		requestParameters: GetShipCooldownRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<GetShipCooldown200Response | null | undefined> {
	 ...
	 */
	async getShipNavRaw(
		requestParameters: GetShipNavRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetShipNav200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/nav`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'GET',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			GetShipNav200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Install Mount
	 */
	async installMountRaw(
		requestParameters: InstallMountOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<InstallMount201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/mounts/install`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			InstallMount201ResponseFromJSON(jsonValue)
		);
	}
	...
	async installMount(
		requestParameters: InstallMountOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<InstallMount201Response> {
	 ...
	 */
	async jettisonRaw(
		requestParameters: JettisonOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<Jettison200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/jettison`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			Jettison200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 */
	async jumpShipRaw(
		requestParameters: JumpShipOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<JumpShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/jump`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			JumpShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Navigate Ship
	 */
	async navigateShipRaw(
		requestParameters: NavigateShipOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<NavigateShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/navigate`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			NavigateShip200ResponseFromJSON(jsonValue)
		);
	}
	...
	async navigateShip(
		requestParameters: NavigateShipOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<NavigateShip200Response> {
	 ...
	 * Negotiate Contract
	 */
	async negotiateContractRaw(
		requestParameters: NegotiateContractRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<NegotiateContract200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/negotiate/contract`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			NegotiateContract200ResponseFromJSON(jsonValue)
		);
	}
	...
	async negotiateContract(
		requestParameters: NegotiateContractRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<NegotiateContract200Response> {
	 ...
	 */
	async orbitShipRaw(
		requestParameters: OrbitShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<OrbitShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/orbit`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			OrbitShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Patch Ship Nav
	 */
	async patchShipNavRaw(
		requestParameters: PatchShipNavOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<GetShipNav200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
	 ...
	 * Purchase Cargo
	 */
	async purchaseCargoRaw(
		requestParameters: PurchaseCargoOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<PurchaseCargo201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/purchase`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			PurchaseCargo201ResponseFromJSON(jsonValue)
		);
	}
	...
	async purchaseCargo(
		requestParameters: PurchaseCargoOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<PurchaseCargo201Response> {
	 ...
	 * Purchase Ship
	 */
	async purchaseShipRaw(
		requestParameters: PurchaseShipOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<PurchaseShip201Response>> {
		const queryParameters: any = {};
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			PurchaseShip201ResponseFromJSON(jsonValue)
		);
	}
	...
	async purchaseShip(
		requestParameters: PurchaseShipOperationRequest = {},
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<PurchaseShip201Response> {
	 ...
	 */
	async refuelShipRaw(
		requestParameters: RefuelShipOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RefuelShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/refuel`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			RefuelShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Remove Mount
	 */
	async removeMountRaw(
		requestParameters: RemoveMountOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RemoveMount201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/mounts/remove`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			RemoveMount201ResponseFromJSON(jsonValue)
		);
	}
	...
	async removeMount(
		requestParameters: RemoveMountOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<RemoveMount201Response> {
	 ...
	 */
	async repairShipRaw(
		requestParameters: RepairShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<RepairShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			RepairShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 */
	async scrapShipRaw(
		requestParameters: ScrapShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ScrapShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			ScrapShip200ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 */
	async sellCargoRaw(
		requestParameters: SellCargoOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<SellCargo201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/sell`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			SellCargo201ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 */
	async shipRefineRaw(
		requestParameters: ShipRefineOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ShipRefine201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/refine`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			ShipRefine201ResponseFromJSON(jsonValue)
		);
	}
	 ...
	 * Siphon Resources
	 */
	async siphonResourcesRaw(
		requestParameters: SiphonResourcesRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<SiphonResources201Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/siphon`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			SiphonResources201ResponseFromJSON(jsonValue)
		);
	}
	...
	async siphonResources(
		requestParameters: SiphonResourcesRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<SiphonResources201Response> {
	 ...
	 * Transfer Cargo
	 */
	async transferCargoRaw(
		requestParameters: TransferCargoOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<TransferCargo200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/transfer`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			TransferCargo200ResponseFromJSON(jsonValue)
		);
	}
	...
	async transferCargo(
		requestParameters: TransferCargoOperationRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<TransferCargo200Response> {
	 ...
	 */
	async warpShipRaw(
		requestParameters: WarpShipRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<WarpShip200Response>> {
		if (requestParameters['shipSymbol'] == null) {
			throw new runtime.RequiredError(
				'shipSymbol',
		...
		const response = await this.request(
			{
				path: `/my/ships/{shipSymbol}/warp`.replace(
					`{${'shipSymbol'}}`,
					encodeURIComponent(String(requestParameters['shipSymbol']))
				),
				method: 'POST',
		...
		return new runtime.JSONApiResponse(response, (jsonValue) =>
			WarpShip200ResponseFromJSON(jsonValue)
		);
	}
