 ...
 */
export function instanceOfGetStatus200ResponseLinksInner(
	value: object
): value is GetStatus200ResponseLinksInner {
...
export function GetStatus200ResponseLinksInnerFromJSONTyped(
	json: any,
...
export function GetStatus200ResponseLinksInnerToJSON(
	value?: GetStatus200ResponseLinksInner | null
): any {
	if (value == null) {
		return value;
	}
