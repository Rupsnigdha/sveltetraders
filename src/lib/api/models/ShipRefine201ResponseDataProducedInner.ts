 ...
 */
export function instanceOfShipRefine201ResponseDataProducedInner(
	value: object
): value is ShipRefine201ResponseDataProducedInner {
	if (!('tradeSymbol' in value) || value['tradeSymbol'] === undefined) return false;
	if (!('units' in value) || value['units'] === undefined) return false;
	return true;
}

export function ShipRefine201ResponseDataProducedInnerFromJSON(
	json: any
): ShipRefine201ResponseDataProducedInner {
	return ShipRefine201ResponseDataProducedInnerFromJSONTyped(json, false);
}

export function ShipRefine201ResponseDataProducedInnerFromJSONTyped(
	json: any,
...
export function ShipRefine201ResponseDataProducedInnerToJSON(
	value?: ShipRefine201ResponseDataProducedInner | null
): any {
	if (value == null) {
		return value;
	}
