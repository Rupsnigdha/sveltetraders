...
import { ShipyardFromJSON, ShipyardFromJSONTyped, ShipyardToJSON } from './Shipyard';
...
export function GetShipyard200ResponseFromJSONTyped(
	json: any,
...
export function GetShipyard200ResponseToJSON(value?: GetShipyard200Response | null): any {
	if (value == null) {
		return value;
	}
	return {
