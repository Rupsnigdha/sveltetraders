...
import { TradeGoodFromJSON, TradeGoodFromJSONTyped, TradeGoodToJSON } from './TradeGood';
	...
	return {
		...
		transactions:
			json['transactions'] == null
				? undefined
				: (json['transactions'] as Array<any>).map(MarketTransactionFromJSON),
		tradeGoods:
			json['tradeGoods'] == null
				? undefined
				: (json['tradeGoods'] as Array<any>).map(MarketTradeGoodFromJSON)
	};
}
	...
	return {
		...
		transactions:
			value['transactions'] == null
				? undefined
				: (value['transactions'] as Array<any>).map(MarketTransactionToJSON),
		tradeGoods:
			value['tradeGoods'] == null
				? undefined
				: (value['tradeGoods'] as Array<any>).map(MarketTradeGoodToJSON)
	};
}
