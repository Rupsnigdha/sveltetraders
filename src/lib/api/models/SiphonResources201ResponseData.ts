...
import { SiphonFromJSON, SiphonFromJSONTyped, SiphonToJSON } from './Siphon';
 ...
 */
export function instanceOfSiphonResources201ResponseData(
	value: object
): value is SiphonResources201ResponseData {
...
export function SiphonResources201ResponseDataFromJSONTyped(
	json: any,
...
export function SiphonResources201ResponseDataToJSON(
	value?: SiphonResources201ResponseData | null
): any {
	if (value == null) {
		return value;
	}
