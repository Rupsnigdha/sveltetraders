 ...
 */
export function instanceOfCreateShipSystemScan201Response(
	value: object
): value is CreateShipSystemScan201Response {
	if (!('data' in value) || value['data'] === undefined) return false;
	return true;
}

export function CreateShipSystemScan201ResponseFromJSON(
	json: any
): CreateShipSystemScan201Response {
	return CreateShipSystemScan201ResponseFromJSONTyped(json, false);
}

export function CreateShipSystemScan201ResponseFromJSONTyped(
	json: any,
...
export function CreateShipSystemScan201ResponseToJSON(
	value?: CreateShipSystemScan201Response | null
): any {
	if (value == null) {
		return value;
	}
