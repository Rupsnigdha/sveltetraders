 ...
 */
export function instanceOfGetRepairShip200ResponseData(
	value: object
): value is GetRepairShip200ResponseData {
...
export function GetRepairShip200ResponseDataFromJSONTyped(
	json: any,
...
export function GetRepairShip200ResponseDataToJSON(
	value?: GetRepairShip200ResponseData | null
): any {
	if (value == null) {
		return value;
	}
