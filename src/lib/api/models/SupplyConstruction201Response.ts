 ...
 */
export function instanceOfSupplyConstruction201Response(
	value: object
): value is SupplyConstruction201Response {
...
export function SupplyConstruction201ResponseFromJSONTyped(
	json: any,
...
export function SupplyConstruction201ResponseToJSON(
	value?: SupplyConstruction201Response | null
): any {
	if (value == null) {
		return value;
	}
