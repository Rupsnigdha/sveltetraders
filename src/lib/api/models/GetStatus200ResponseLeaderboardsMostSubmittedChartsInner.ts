 ...
 */
export function instanceOfGetStatus200ResponseLeaderboardsMostSubmittedChartsInner(
	value: object
): value is GetStatus200ResponseLeaderboardsMostSubmittedChartsInner {
...
export function GetStatus200ResponseLeaderboardsMostSubmittedChartsInnerFromJSON(
	json: any
...
export function GetStatus200ResponseLeaderboardsMostSubmittedChartsInnerFromJSONTyped(
	json: any,
...
export function GetStatus200ResponseLeaderboardsMostSubmittedChartsInnerToJSON(
	value?: GetStatus200ResponseLeaderboardsMostSubmittedChartsInner | null
): any {
	if (value == null) {
		return value;
	}
