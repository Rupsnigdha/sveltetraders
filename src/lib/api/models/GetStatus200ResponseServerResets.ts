 ...
 */
export function instanceOfGetStatus200ResponseServerResets(
	value: object
): value is GetStatus200ResponseServerResets {
	if (!('next' in value) || value['next'] === undefined) return false;
	if (!('frequency' in value) || value['frequency'] === undefined) return false;
	return true;
}

export function GetStatus200ResponseServerResetsFromJSON(
	json: any
): GetStatus200ResponseServerResets {
	return GetStatus200ResponseServerResetsFromJSONTyped(json, false);
}

export function GetStatus200ResponseServerResetsFromJSONTyped(
	json: any,
...
export function GetStatus200ResponseServerResetsToJSON(
	value?: GetStatus200ResponseServerResets | null
): any {
	if (value == null) {
		return value;
	}
