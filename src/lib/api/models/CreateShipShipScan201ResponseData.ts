...
import { ScannedShipFromJSON, ScannedShipFromJSONTyped, ScannedShipToJSON } from './ScannedShip';
 ...
 */
export function instanceOfCreateShipShipScan201ResponseData(
	value: object
): value is CreateShipShipScan201ResponseData {
	if (!('cooldown' in value) || value['cooldown'] === undefined) return false;
	if (!('ships' in value) || value['ships'] === undefined) return false;
	return true;
}

export function CreateShipShipScan201ResponseDataFromJSON(
	json: any
): CreateShipShipScan201ResponseData {
	return CreateShipShipScan201ResponseDataFromJSONTyped(json, false);
}

export function CreateShipShipScan201ResponseDataFromJSONTyped(
	json: any,
...
export function CreateShipShipScan201ResponseDataToJSON(
	value?: CreateShipShipScan201ResponseData | null
): any {
	if (value == null) {
		return value;
	}
