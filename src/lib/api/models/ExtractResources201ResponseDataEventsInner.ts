...
export function ExtractResources201ResponseDataEventsInnerFromJSON(
	json: any
): ExtractResources201ResponseDataEventsInner {
	return ExtractResources201ResponseDataEventsInnerFromJSONTyped(json, false);
}

export function ExtractResources201ResponseDataEventsInnerFromJSONTyped(
	json: any,
...
export function ExtractResources201ResponseDataEventsInnerToJSON(
	value?: ExtractResources201ResponseDataEventsInner | null
): any {
	if (value == null) {
		return value;
	}
