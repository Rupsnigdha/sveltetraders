 ...
 */
export function instanceOfRepairShip200ResponseData(
	value: object
): value is RepairShip200ResponseData {
...
export function RepairShip200ResponseDataFromJSONTyped(
	json: any,
...
export function RepairShip200ResponseDataToJSON(value?: RepairShip200ResponseData | null): any {
	if (value == null) {
		return value;
	}
	return {
