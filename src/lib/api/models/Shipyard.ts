	...
	return {
		...
		transactions:
			json['transactions'] == null
				? undefined
				: (json['transactions'] as Array<any>).map(ShipyardTransactionFromJSON),
		ships:
			json['ships'] == null ? undefined : (json['ships'] as Array<any>).map(ShipyardShipFromJSON),
	...
	return {
		...
		transactions:
			value['transactions'] == null
				? undefined
				: (value['transactions'] as Array<any>).map(ShipyardTransactionToJSON),
		ships:
			value['ships'] == null ? undefined : (value['ships'] as Array<any>).map(ShipyardShipToJSON),
