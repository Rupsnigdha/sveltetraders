 ...
 */
export function instanceOfNegotiateContract200ResponseData(
	value: object
): value is NegotiateContract200ResponseData {
	if (!('contract' in value) || value['contract'] === undefined) return false;
	return true;
}

export function NegotiateContract200ResponseDataFromJSON(
	json: any
): NegotiateContract200ResponseData {
	return NegotiateContract200ResponseDataFromJSONTyped(json, false);
}

export function NegotiateContract200ResponseDataFromJSONTyped(
	json: any,
...
export function NegotiateContract200ResponseDataToJSON(
	value?: NegotiateContract200ResponseData | null
): any {
	if (value == null) {
		return value;
	}
