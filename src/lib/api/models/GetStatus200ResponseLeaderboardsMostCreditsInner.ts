 ...
 */
export function instanceOfGetStatus200ResponseLeaderboardsMostCreditsInner(
	value: object
): value is GetStatus200ResponseLeaderboardsMostCreditsInner {
	if (!('agentSymbol' in value) || value['agentSymbol'] === undefined) return false;
	if (!('credits' in value) || value['credits'] === undefined) return false;
	return true;
}

export function GetStatus200ResponseLeaderboardsMostCreditsInnerFromJSON(
	json: any
...
export function GetStatus200ResponseLeaderboardsMostCreditsInnerFromJSONTyped(
	json: any,
...
export function GetStatus200ResponseLeaderboardsMostCreditsInnerToJSON(
	value?: GetStatus200ResponseLeaderboardsMostCreditsInner | null
): any {
	if (value == null) {
		return value;
	}
