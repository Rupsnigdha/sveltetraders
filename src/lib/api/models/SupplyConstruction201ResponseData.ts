 ...
 */
export function instanceOfSupplyConstruction201ResponseData(
	value: object
): value is SupplyConstruction201ResponseData {
	if (!('construction' in value) || value['construction'] === undefined) return false;
	if (!('cargo' in value) || value['cargo'] === undefined) return false;
	return true;
}

export function SupplyConstruction201ResponseDataFromJSON(
	json: any
): SupplyConstruction201ResponseData {
	return SupplyConstruction201ResponseDataFromJSONTyped(json, false);
}

export function SupplyConstruction201ResponseDataFromJSONTyped(
	json: any,
...
export function SupplyConstruction201ResponseDataToJSON(
	value?: SupplyConstruction201ResponseData | null
): any {
	if (value == null) {
		return value;
	}
