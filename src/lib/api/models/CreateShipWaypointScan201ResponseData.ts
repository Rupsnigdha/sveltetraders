 ...
 */
export function instanceOfCreateShipWaypointScan201ResponseData(
	value: object
): value is CreateShipWaypointScan201ResponseData {
	if (!('cooldown' in value) || value['cooldown'] === undefined) return false;
	if (!('waypoints' in value) || value['waypoints'] === undefined) return false;
	return true;
}

export function CreateShipWaypointScan201ResponseDataFromJSON(
	json: any
): CreateShipWaypointScan201ResponseData {
	return CreateShipWaypointScan201ResponseDataFromJSONTyped(json, false);
}

export function CreateShipWaypointScan201ResponseDataFromJSONTyped(
	json: any,
...
export function CreateShipWaypointScan201ResponseDataToJSON(
	value?: CreateShipWaypointScan201ResponseData | null
): any {
	if (value == null) {
		return value;
	}
