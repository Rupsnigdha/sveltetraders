 ...
 */
export function instanceOfDeliverContract200ResponseData(
	value: object
): value is DeliverContract200ResponseData {
...
export function DeliverContract200ResponseDataFromJSONTyped(
	json: any,
...
export function DeliverContract200ResponseDataToJSON(
	value?: DeliverContract200ResponseData | null
): any {
	if (value == null) {
		return value;
	}
