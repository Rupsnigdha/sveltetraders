 ...
 */
export function instanceOfAcceptContract200ResponseData(
	value: object
): value is AcceptContract200ResponseData {
...
export function AcceptContract200ResponseDataFromJSONTyped(
	json: any,
...
export function AcceptContract200ResponseDataToJSON(
	value?: AcceptContract200ResponseData | null
): any {
	if (value == null) {
		return value;
	}
