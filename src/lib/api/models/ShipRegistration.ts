...
import { ShipRoleFromJSON, ShipRoleFromJSONTyped, ShipRoleToJSON } from './ShipRole';
...
export function ShipRegistrationFromJSONTyped(
	json: any,
...
export function ShipRegistrationToJSON(value?: ShipRegistration | null): any {
	if (value == null) {
		return value;
	}
	return {
